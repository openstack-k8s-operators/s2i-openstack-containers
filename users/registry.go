...
// container image builds use the generated zz_generated_users.txt
// (regenerate with: make generate-service-uids).
// The uid_gid_manage script in containers/base/scripts/ reads the same
// text file at image build time to create the system users.
package users
...
// source of truth — the gen-users tool marshals this to
// zz_generated_users.txt for container image builds
