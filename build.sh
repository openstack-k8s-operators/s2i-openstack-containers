...
case "${ACTION}" in
  ...
  list)
    ...
    ;;
  *)
    echo "Usage: STREAM=<name> $0 {build|build-parallel|push|refs|resolve|auto-detect|images-from-changes|list-sources|sync-locks|prefetch-cargo|update-sources|update-lockfiles|install-deps|list} [target ...]"
    echo ""
    echo "Commands:"
